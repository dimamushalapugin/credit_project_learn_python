...
def read_delta_html(client_inn, object_inn, short_name):
    ...
    delta_description_of_the_company = {
        'Статус компании:': info_delta(soup, 'Статус компании'),
        'Дата регистрации:': info_delta(soup, 'Дата регистрации'),
        'Документы, поданные для регистрации/изменения в ЕГРЮЛ:': info_delta(soup, 'Документы, поданные для регистрации/изменения в ЕГРЮЛ'),
        'Адрес регистрации организации:': info_delta(soup, 'Адрес регистрации организации'),
        'Размер уставного капитала:': info_delta(soup, 'Размер уставного капитала'),
        'Массовость директоров/учредителей:': info_delta(soup, 'Массовость директоров/учредителей'),
        'Дисквалифицированные лица:': info_delta(soup, 'Дисквалифицированные лица'),
        'Преступления, связанные с оборотом наркотиков по данным УФСКН России:': info_delta(soup, 'Преступления, связанные с оборотом наркотиков по данным УФСКН России'),
        'Смена директоров/учредителей:': info_delta(soup, 'Cмена директоров/учредителей'),
        'Госконтракты:': info_delta(soup, 'Госконтракты'),
        'Сообщения о банкротстве:': info_delta(soup, 'Сообщения о банкротстве'),
        'Налоговая задолженность и отчетность:': info_delta(soup, 'Налоговая задолженность и отчетность'),
        ...
        'Наличие дочерних компаний:': info_delta(soup, 'Наличие дочерних компаний'),
