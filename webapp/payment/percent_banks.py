...
def main(data):
    ...
    period_month = extract_file(data)[2]
    ...
    class PeriodDataProcessor:
        ...
        def process_data(self):
            ...
            if month_year_table == extract_file(data)[0]:
                new_row_xlsx = extract_file(data)[1]
                ...
                extract_file_new = pd.concat([new_row_xlsx, extract_file(data)[1]], ignore_index=True).drop(columns='№')
