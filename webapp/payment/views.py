...
from webapp.sql_queries import (
    write_to_db,
...
@blueprint.route(
    "/full_credit_info/<path:leasing_contract_number>", methods=["GET", "POST"]
)
def full_credit_info(leasing_contract_number):
    ...
    lcn = LeasingContract.query.filter(
        LeasingContract.leasing_contract_number == leasing_contract_number
    ).first()
    return render_template(
        "full_credit_page.html", leasing_contract_number=leasing_contract_number
    )
...
def create_payment():
    ...
    if request.method == "POST":
        ...
        leasing_contract = assign_leasing_contract_id(
            leasing_contract_number, client, seller
        )
        ...
        new_payment = Payment(
            ...
            leasing_contract_id=leasing_contract,
